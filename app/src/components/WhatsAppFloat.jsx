...
export default function WhatsAppFloat() {
  ...
  return (
    ...
    >
      {/* Tooltip bubble */}
      {showTooltip && (
        <div className="bg-white text-gray-800 text-sm font-semibold px-4 py-3 rounded-2xl rounded-br-sm shadow-xl border border-gray-100 max-w-[200px] text-center animate-float">
          Precisa de ajuda?<br />
          <span className="text-[#19A3B0]">Fale comigo agora!</span>
      ...
      <a
        ...
        className="relative bg-[#25D366] hover:bg-[#1fba59] text-white w-16 h-16 rounded-full shadow-2xl shadow-green-400/40 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-green-400/60"
